...
export const MobileNav: React.FC<MobileNavProps> = ({
  ...
  return (
    <>
      ...
      <nav 
        className="absolute bottom-0 left-0 right-0 w-full z-40 bg-zinc-950/95 backdrop-blur-xl border-t border-white/10 py-2.5 px-4 flex justify-between items-center shrink-0 shadow-[0_-2px_10px_rgba(0,0,0,0.08)]"

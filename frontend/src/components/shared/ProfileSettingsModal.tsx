      ...
      <div className="relative w-full max-w-2xl bg-white rounded-2xl border border-slate-200 shadow-2xl p-6 md:p-8 animate-scale-up font-sans flex flex-col max-h-[85vh]">
              ...
              <div className="p-4 bg-indigo-50/60 border border-indigo-100 rounded-2xl space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <span className="px-2 py-0.5 rounded-md bg-indigo-600 text-white font-mono text-[9px] font-black uppercase">
                    {activePod?.clinicCode || activeProfile?.clinic_code || activeProfile?.clinicCode || 'MF-APEX'}
                  </span>
                </div>
        ...
        <div className="border-t border-slate-200 pt-4 mt-4 flex items-center justify-between shrink-0">
          <span className="text-[9.5px] text-slate-600 font-bold uppercase tracking-wider">
            Connected: {activePod?.clinicCode || activeProfile?.clinic_code || activeProfile?.clinicCode || 'MF-APEX'}
          </span>
          <button 
            onClick={onClose}

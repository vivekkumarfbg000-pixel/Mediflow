...
async function run() {
  ...
  const migrationPath = path.join(__dirname, '..', 'supabase', 'migrations', '20260605000003_harden_profiles_self_access_rls.sql');
  ...
  console.log('3. Applying profiles RLS migration via execute_autonomous_db_repair...');
  const runId = 'profiles_rls_' + Date.now();

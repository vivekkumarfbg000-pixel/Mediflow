-- Fix on_encounter_submitted to execute on AFTER INSERT OR UPDATE ON encounters
-- This ensures that diagnostics and medications inserted after the active encounter row are correctly processed
...
BEGIN
    ...
    -- Action C: Generate unified invoice

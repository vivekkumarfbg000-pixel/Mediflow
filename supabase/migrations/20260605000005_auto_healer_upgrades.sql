-- Mediflow Tech Team Upgrade Migration - reconcile_profile_role
-- Drops old reconcile function if it exists to avoid type conflict
DROP FUNCTION IF EXISTS public.reconcile_profile_role();

-- Create reconcile_profile_role function

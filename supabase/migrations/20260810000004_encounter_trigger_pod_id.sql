-- Migration: on_encounter_submitted pod_id Scoping Fix
-- Enforces proper pod_id isolation on lab_requisitions, inventory_holds, unified_invoices, and activity_logs
-- generated automatically by the on_encounter_submitted trigger function.
...
GRANT EXECUTE ON FUNCTION public.on_encounter_submitted() TO service_role;
